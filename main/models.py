...
class Article(models.Model):
    ...
    subject = models.ForeignKey('Subject', verbose_name='Тематики', related_name='articles', on_delete=models.PROTECT,
                                blank=True, null=True)
    color = models.CharField(max_length=1, choices=(('b', 'чернай'), ('w', 'белый')), null=True, blank=True)
